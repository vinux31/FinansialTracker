...
note: |
  This plan has 9 tasks (exceeds typical 2-3 target) due to tight dependencies in Supabase setup.
  All components (client utilities, migrations, middleware, RLS) are needed before authentication can work.
  Splitting into multiple plans would create complex dependencies without clear parallelization benefits.
---
...
<task type="checkpoint:human-action" gate="blocking">
  <name>Configure Supabase project and environment variables</name>
...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Verify Supabase infrastructure setup</name>
  <what-built>
